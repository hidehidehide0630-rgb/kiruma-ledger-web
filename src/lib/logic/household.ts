...
【予算と単位】
- 目標予算: ${tripBudget}円。
- 鶏むね肉、卵、もやし、豆腐などの安価な食材を駆使すれば、低予算でも質の高い献立を構成することは十分に可能です。プロの知恵を絞り、極限までコスパの良い構成にしてください。
- ただし、どうしても予算内に収まらない場合は、数千円オーバーしても全く構いません。予算に収めるために「在庫を捏造して0円にする」行為は致命的なシステムエラーになるため絶対にやめてください。必要な食材はすべて「購入（isFirstPurchase: true）」として価格を計上してください。
- 単位: 「鶏むね肉 1枚(約300g)」「卵 1パック(10個)」など、現実の買い物と同じ形式。
